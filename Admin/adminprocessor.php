...
//    $email = $_POST['email'];
    ...
    if ( $dob == "" || $height == "" || $weight == "" || $phone_number == "") {
        ...
        $save = "insert into c_child_details(full_name,mothers_name,fathers_name,dob,gender,height,weight,phone,email) values('$full_name','$mother_name','$father_name','$dob','$gender','$height','$weight','$phone','$email')";

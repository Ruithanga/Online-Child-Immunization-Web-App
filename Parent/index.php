...
<div class="bg">
    <center>
        <a href= "add_child.html"><div class="btn"><img src="images/avatar.jpg" />
                <br>Add Child Details</div></a>
        <a href= "view_details.php"><div class="btn"><img src="images/avatar.jpg" />
                <br>View Child Details</div></a>
        <a href= "vaccinereminder.php"><div class="btn"><img src="images/avatar.jpg" />
